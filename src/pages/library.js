    ...
    <div className="min-h-screen flex flex-col px-4 py-6 md:px-6 bg-gray-50">
      <div className="flex flex-col gap-6 max-w-4xl mx-auto w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 md:p-8 shadow-md">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Library Block</h1>
          <p className="text-gray-600 mb-6">Your current location. Get directions to other campus buildings from the navigation above.</p>
        </div>
